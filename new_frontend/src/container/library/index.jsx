...
import fetchArrayBasicInfo_library from "../../../api/fetch/fetchArrayBasicInfo_library";
...
function Library() {
    ...
    useEffect(() => {
        ...
        //รอแทนที่ด้วยฟังก์ชั่นสำหรับ Library
        fetchArrayBasicInfo_library()
        .then(anime =>{
            console.log(anime)
            console.log("wtf")
    ...
    <>
        ...
        <div className="bg-black min-h-screen flex flex-col">
            ...
            <div className="flex-1 bg-gradient-to-b from-slate-200 to-slate-400 text-black p-8">
                ...
                <h2 className="text-2xl font-bold mt-7 mb-4">[<HeartOutlined />] รายการที่คุณชื่นชอบ</h2>
                ...
                <div className="min-h-px flex items-center justify-center">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                            <img src={not_found} className="mx-auto mb-4 w-96 h-96 object-cover mt-48"/>
                            <p className="text-lg text-black"><WarningOutlined /> รายการโปรดของคุณตอนนี้ยังไม่มีหนังสือเพิ่มเข้ามา</p>
                        </div>
                    </div>
                </div>
                }
